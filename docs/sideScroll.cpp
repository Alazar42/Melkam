...
public:
    void onUpdate(Scene &scene, float dt) override
    {
        for (auto &entity : scene.view<CharacterBody2DComponent, Velocity2DComponent>())
        {
            ...
            velocity->velocity[0] = inputX * character->speed;
...
int main()
{
    ...
    playerTransform.position.y = 120.0f;
    auto &playerBody = player.addComponent<CharacterBody2DComponent>();
    playerBody.speed = 220.0f;
    playerBody.gravity = 1200.0f;
    playerBody.jumpStrength = 420.0f;
    ...
    wallTransform.position.y = 300.0f;
    ...
    floorTransform.position.y = 600.0f;
    ...
    floorBox.size[0] = 800.0f;
    floorBox.size[1] = 50.0f;
    ...
    pillarTransform.position.x = 360.0f;
    pillarTransform.position.y = 420.0f;
